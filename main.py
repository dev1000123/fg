...
"""))
level = 0
controller.move_sprite(mySprite3, 50, 50)

def on_update_interval():
    global mySprite2, score
    mySprite2 = sprites.create(img("""
        ...
        SpriteKind.projectile)
    score = "in"
    mySprite2.set_position(randint(0, 150), randint(36, 113))
